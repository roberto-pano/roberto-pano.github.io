  ...
  return (
    <div>
      ...
      <div
        ...
        <button onClick={prevMonth} className="project_button">
          Prev
        </button>
        <button onClick={nextMonth} className="project_button">
          Next
        </button>
      </div>
      ...
      <div
        ...
        {days.map((d, idx) => (
          <div
            key={idx}
            id={String(d.num)}
            className={d.currentMonth ? 'day' : 'prev-date'}
            onClick={() => {
              if (d.currentMonth) {
      ...
      <div style={{marginTop: 20}}>
        ...
        {username ? (
          ...
          <div>
            <input
              id="local_login"
              placeholder="Enter a username to sign in locally"
            />
            <button
              onClick={() => {
